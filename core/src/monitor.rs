...
impl Monitor {
    pub fn new(send_count: Arc<AtomicU64>, recv_count: Arc<AtomicU64>) -> Monitor {
        Monitor { terminate: AtomicBool::new(false), send_count, recv_count }
    }
    ...
    pub fn worker(self: &Arc<Monitor>, _core: Arc<Core>) {
        ...
        loop {
            ...
            trace!(
                "sent: {} received: {} pending: {} -> send rate tx/s: {} receive rate tx/s: {}",
