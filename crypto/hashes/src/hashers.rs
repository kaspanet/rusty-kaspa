...
mod tests {
    ...
    impl<T: Hasher> HasherObject for T {
        fn update(&mut self, data: &[u8]) {
            <Self as Hasher>::update(self, data);
        }
        fn finalize(&self) -> Hash {
            <Self as Hasher>::finalize(self.clone())
        }
        fn reset(&mut self) {
            <Self as Hasher>::reset(self)
        }
    }
    ...
    fn test_vectors() {
        ...
        let vectors = [
            (Box::new(TransactionHash::new()) as Box<dyn HasherObject>, [
            ...
            (Box::new(TransactionID::new()) as _, [
            ...
            (Box::new(TransactionSigningHash::new()) as _, [
            ...
            // (Box::new(TransactionSigningHashECDSA::new()) as _, [
            ...
            (Box::new(MerkleBranchHash::new()) as _, [
        ...
        for (mut hasher, expected) in vectors {
