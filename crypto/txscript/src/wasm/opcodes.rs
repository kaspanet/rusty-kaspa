...
pub enum Opcodes {
    ...
    OpTxSubnetId = 0xb6,
    OpTxGas = 0xb7,
    OpTxPayloadSubstr = 0xb8,
    OpTxInputIndex = 0xb9,
    OpOutpointTxId = 0xba,
    OpOutpointIndex = 0xbb,
    OpTxInputScriptSigSubstr = 0xbc,
    OpTxInputSeq = 0xbd,
    OpTxInputAmount = 0xbe,
    OpTxInputSpk = 0xbf,
    OpTxInputDaaScore = 0xc0,
    OpTxInputIsCoinbase = 0xc1,
    OpTxOutputAmount = 0xc2,
    OpTxOutputSpk = 0xc3,
    OpTxPayloadLen = 0xc4,
    OpTxInputSpkLen = 0xc5,
    OpTxInputSpkSubstr = 0xc6,
    OpTxOutputSpkLen = 0xc7,
    OpTxOutputSpkSubstr = 0xc8,
    OpTxInputScriptSigLen = 0xc9,
    OpUnknown202 = 0xca,
    OpAuthOutputCount = 0xcb,
    OpAuthOutputIdx = 0xcc,
    OpNum2Bin = 0xcd,
    OpBin2Num = 0xce,
    ...
    OpOutputCovenantId = 0xd5,
    OpUnknown214 = 0xd6,
    OpCheckSigFromStack = 0xd7,
    OpCheckSigFromStackECDSA = 0xd8,
    OpBlake3 = 0xd9,
    OpBlake3WithKey = 0xda,
    OpUnknown219 = 0xdb,
    OpUnknown220 = 0xdc,
    OpUnknown221 = 0xdd,
    OpUnknown222 = 0xde,
