...
pub const MAX_SCRIPTS_SIZE: usize = 300_000; // TODO(covpp-mainnet): Add proper activation logic s.t. the pre-fork limit is restored, and the post-fork is unlimited.
pub const MAX_SCRIPT_ELEMENT_SIZE: usize = 1_000_000; // TODO(covpp-mainnet): Add proper activation logic s.t. the pre-fork limit is restored, and the post-fork is unlimited.
pub const MAX_OPS_PER_SCRIPT: i32 = 20_100; // TODO(covpp-mainnet): Add proper activation logic s.t. the pre-fork limit is restored, and the post-fork is unlimited.
