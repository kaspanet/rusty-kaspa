...
use crate::zk_to_script::{
    BoundedR0SuccinctFixedJournalScript, BoundedR0SuccinctScript, ZkScriptBuilder, builder::proof::FinalizedR0Script,
    push_r0_succinct_witness,
};
use risc0_binfmt::Digestible;
use risc0_zkvm::{Digest, SuccinctReceipt};

impl ZkScriptBuilder<BoundedR0SuccinctScript> {
...
impl ZkScriptBuilder<BoundedR0SuccinctFixedJournalScript> {
