...
You can experiment with non-standard consensus parameters by supplying a JSON file with `--override-params-file <path>`. See [docs/override-params.md](docs/override-params.md) for a more detailed explanation.