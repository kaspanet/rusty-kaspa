...
use kaspa_consensus_client::{ITransactionInput, ITransactionOutput, Transaction, TransactionInput, TransactionOutput};
...
impl PSKT {
    ...
    pub fn input(&self, input: &ITransactionInput) -> Result<PSKT> {
    ...
    pub fn output(&self, output: &ITransactionOutput) -> Result<PSKT> {
