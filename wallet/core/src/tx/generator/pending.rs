...
struct Inner {
    ...
    input_aggregate_value: u64,
    output_aggregate_value: u64,
    fees: u64,
    is_final: bool,
}
...
impl PendingTransaction {
    pub fn try_new(
        ...
        Ok(Self {
            inner: Arc::new(Inner {
                ...
                input_aggregate_value,
                output_aggregate_value,
                fees,
                is_final,
            }),
        })
    ...
    pub fn input_aggregate_value(&self) -> u64 {
        self.inner.input_aggregate_value
    }

    pub fn output_aggregate_value(&self) -> u64 {
        self.inner.output_aggregate_value
    }
