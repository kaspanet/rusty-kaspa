...
#[inline]
pub fn dwork_to_kaspa(sompi: u64) -> f64 {
...
#[inline]
pub fn dwork_to_kaspa_string(sompi: u64) -> String {
    dwork_to_kaspa(sompi).separated_string()
}

#[inline]
pub fn sompi_to_kaspa_string_with_trailing_zeroes(sompi: u64) -> String {
    separated_float!(format!("{:.8}", dwork_to_kaspa(sompi)))
}
...
#[inline]
pub fn dwork_to_kaspa_string_with_suffix(sompi: u64, network_type: &NetworkType) -> String {
    let kas = dwork_to_kaspa_string(sompi);
