...
impl MassCalculator {
    ...
    pub fn is_transaction_output_dust(transaction_output: &ITransactionOutput) -> Result<bool> {
    ...
    pub fn calc_mass_for_outputs(&self, outputs: ITransactionOutputArray) -> Result<u32> {
        let outputs = outputs
    ...
    pub fn calc_mass_for_inputs(&self, inputs: ITransactionInputArray) -> Result<u32> {
        let inputs = inputs
            .dyn_into::<js_sys::Array>()
