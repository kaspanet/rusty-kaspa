...
const SEAL_FILE = path.join(__dirname, 'fixtures', 'direct', 'succinct.seal.hex');
const CLAIM_FILE = path.join(__dirname, 'fixtures', 'direct', 'succinct.claim.hex');
const HASHFN_FILE = path.join(__dirname, 'fixtures', 'direct', 'succinct.hashfn.hex');
const CONTROL_INDEX_FILE = path.join(__dirname, 'fixtures', 'direct', 'succinct.control_index.hex');
const CONTROL_DIGESTS_FILE = path.join(__dirname, 'fixtures', 'direct', 'succinct.control_digests.hex');
const CONTROL_ID_FILE = path.join(__dirname, 'fixtures', 'direct', 'succinct.control_id.hex');
const JOURNAL_FILE = path.join(__dirname, 'fixtures', 'direct', 'succinct.journal.hex');
const IMAGE_ID_FILE = path.join(__dirname, 'fixtures', 'direct', 'succinct.image.hex');
