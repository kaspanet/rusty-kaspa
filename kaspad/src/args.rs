...
impl Args {
    pub fn apply_to_config(&self, config: &mut Config) {
        ...
        config.confindex = self.confindex;
...
pub fn cli() -> Command {
    ...
    let cmd = Command::new("kaspad")
        ...
        .arg(arg!(--confindex "Enable the Confirmation index"))
...
impl Args {
        ...
        T: Into<OsString> + Clone,
    {
        ...
        let args = Args {
            ...
            confindex: m.get_one::<bool>("confindex").cloned().unwrap_or(defaults.confindex),
...
/*
  ...
  -d, --loglevel=                           Logging level for all subsystems {trace, debug, info, warn, error,
      ...
      --maxutxocachesize=                   Max size of loaded UTXO into ram from the disk in bytes (default:
                                            5000000000)
      --confindex                           Enable the Confirmation index (for scanning by accepting blue score / num of confirmations)
