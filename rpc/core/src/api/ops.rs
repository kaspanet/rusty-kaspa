...
pub enum RpcApiOps {
    ...
    BlockHeaderAddedNotification = 69,
    ...
    pub fn is_subscription(&self) -> bool {
        matches!(
            ...
            RpcApiOps::NotifyBlockAdded
                ...
                | RpcApiOps::NotifyBlockHeaderAdded
                | RpcApiOps::Subscribe
...
impl From<EventType> for RpcApiOps {
    fn from(item: EventType) -> Self {
        match item {
            ...
            EventType::BlockHeaderAdded => RpcApiOps::BlockHeaderAddedNotification,
        }
    }
}
