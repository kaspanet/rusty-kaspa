...
use keryx_notify::scope::{NewBlockTemplateScope, Scope};
...
async fn test_client_server_sanity_check() {
    keryx_core::log::try_init_logger("info, keryx_grpc_core=trace, keryx_grpc_server=trace, keryx_grpc_client=trace");
