...
from!(item: &kaspa_rpc_core::RpcOptionalCovenantBinding, protowire::RpcCovenantBinding, {
   Self {
...
try_from!(item: &protowire::RpcCovenantBinding, kaspa_rpc_core::RpcOptionalCovenantBinding, {
