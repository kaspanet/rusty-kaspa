...
impl RpcApi for GrpcClient {
    ...
    route!(get_transactions_by_accepting_blue_score_call, GetTransactionsByAcceptingBlueScore);
    route!(get_transactions_by_including_daa_score_call, GetTransactionsByIncludingDaaScore);
