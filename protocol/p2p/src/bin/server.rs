...
use kaspa_p2p_lib::{echo::EchoFlowInitializer, Adaptor};
...
async fn main() {
    ...
    let adaptor = kaspa_p2p_lib::Adaptor::bidirectional(ip_port, initializer, mpsc_channel(Adaptor::hub_channel_size())).unwrap();
