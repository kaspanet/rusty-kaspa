...
use keryx_p2p_lib::echo::EchoFlowInitializer;
...
async fn main() {
    // [-] - init logger
    keryx_core::log::init_logger(None, "debug");
    ...
    let adaptor = keryx_p2p_lib::Adaptor::bidirectional(ip_port, keryx_p2p_lib::Hub::new(), initializer, Default::default()).unwrap();
