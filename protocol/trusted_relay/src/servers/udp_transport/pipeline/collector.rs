...
use crate::servers::udp_transport::pipeline::verification::{PacketReceivedMessage, VerificationMessage, VerificationReceiver, VerificationSender};
...
pub fn spawn_collector_thread(
    ...
    let handle = std::thread::Builder::new()
        ...
        .spawn(move || {
            run(collector_idx, socket, verification_receivers, verification_senders, transport_params.default_buffer_size, config, shutting_down.clone());
        })
