...
pub struct HeaderProcessor {
    ...
    pub(super) depth_manager: BlockAtDepthDepthManager<DbDepthStore, DbReachabilityStore, DbGhostdagStore>,
...
impl HeaderProcessor {
    ...
    pub fn new(
        ...
        depth_manager: BlockAtDepthDepthManager<DbDepthStore, DbReachabilityStore, DbGhostdagStore>,
        counters: Arc<ProcessingCounters>,
    ) -> Self {
        Self {
            receiver,
