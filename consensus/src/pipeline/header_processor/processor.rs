...
impl HeaderProcessor {
    pub fn new(
        ...
        Self {
            ...
            pruning_lock,
            counters,
            // TODO (HF): make sure to pass `new_timestamp_deviation_tolerance` and use according to HF activation score
            timestamp_deviation_tolerance: params.legacy_timestamp_deviation_tolerance,
