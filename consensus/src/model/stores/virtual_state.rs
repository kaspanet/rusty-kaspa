...
impl From<PreToccataVirtualState> for VirtualState {
    fn from(v: PreToccataVirtualState) -> Self {
        Self {
            parents: v.parents,
            // TODO[DK]: Possibly revisit
            coloring_ghostdag_data: v.ghostdag_data.clone(),
            topology_ghostdag_data: v.ghostdag_data,
...
mod tests {
    ...
    fn post_toccata_set_lands_at_versioned_key() {
        ...
        let state = Arc::new(VirtualState {
            ...
            coloring_ghostdag_data: GhostdagData::default(),
            topology_ghostdag_data: GhostdagData::default(),
            daa_score: 1234,
            bits: 0x1e00ffff,
