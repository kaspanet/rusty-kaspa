...
pub fn create_transaction(tx_to_spend: &MutableTransaction, fee: u64) -> MutableTransaction {
    ...
    let output = TransactionOutput::new(tx_to_spend.tx.outputs[0].value - fee, script_public_key);
