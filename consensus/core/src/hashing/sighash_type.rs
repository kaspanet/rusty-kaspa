...
// SIG_HASH_MASK defines the number of bits of the hash type which is used
...
impl SigHashType {
    pub fn is_sighash_all(self) -> bool {
        self.0 & SIG_HASH_ALL.0 == SIG_HASH_ALL.0
    }

    pub fn is_sighash_none(self) -> bool {
        self.0 & SIG_HASH_NONE.0 == SIG_HASH_NONE.0
    }

    pub fn is_sighash_single(self) -> bool {
        self.0 & SIG_HASH_SINGLE.0 == SIG_HASH_SINGLE.0
    }
