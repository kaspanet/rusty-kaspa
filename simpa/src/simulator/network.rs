...
impl KaspaNetworkSimulator {
    pub fn new(delay: f64, bps: f64) -> Self {
        Self { env: Env::new(), miners: RefCell::new(Vec::new()), processes: RefCell::new(HashMap::new()), delay, bps }
    }

    pub fn init(self: Rc<Self>, num_miners: u64) -> Rc<Self> {
        for i in 0..num_miners {
            let (mine_id, recv_id) = (i * 2, i * 2 + 1);
            let miner = Rc::new(Miner::new(mine_id, recv_id, self.bps, 1f64 / num_miners as f64));
